...
int main(int argc, char* argv[]) {
    try {
        ...
        l_LineReader.SetOnInputLineCallback([&l_AccessClient](const std::vector<unsigned char> a_Buffer){ l_AccessClient.Send(std::move(PacketData::CreatePacket(a_Buffer, true)));});
